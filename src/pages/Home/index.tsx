          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h1 className="text-6xl font-extrabold leading-[1.05] tracking-tight text-white lg:text-8xl">
                Come connect{' '}
                <span className="text-gold">Clique.</span>
              </h1>
              <p className="max-w-[500px] text-lg leading-relaxed text-slate-400">
                A space to meet people who share your vibe, your interests,
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
            <div className="group flex flex-col gap-6">
              ...
              <p className="text-slate-500 leading-relaxed">
                Suggestions based on shared core values and niche interests,
            ...
            <div className="group flex flex-col gap-6">
              ...
              <p className="text-slate-500 leading-relaxed">
                Dedicated, high-quality spaces focused on specific hobbies
                from coding to urbanism.
              </p>
            </div>
            <div className="group flex flex-col gap-6">
              <span className="material-symbols-outlined text-4xl text-white">
              ...
              <p className="text-slate-500 leading-relaxed">
                A community-moderated environment where your data remains
                yours, always.
              </p>
            </div>
          </div>
